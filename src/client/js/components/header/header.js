...
export default class Header extends Component {
  ...
  mounted() {
    const { scrolled, toggleEnableLoginModal, toggleEnableSignUpModal } =
      this.props;
  ...
  template() {
    return `
                ...
                <Options class="options ${
                  this.state.third_tab_click ? 'block' : 'hidden'
                }">
                </Options>
        `;
  }
